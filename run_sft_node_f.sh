...
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True accelerate launch --config_file configs/my_accelerate_config_zero1.yaml scripts/train_llm_llama3.py --output_dir /gs/bs/tga-okazaki/ma/ckpts/${NAME}_${SEED} \
--run_name $NAME \
--data_files ${DATA[*]} \
